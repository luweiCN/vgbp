...
import { User, X, Mail, AlertTriangle, Eye, EyeOff, CheckCircle, Info, Lock, LogIn, UserPlus } from 'lucide-react';
    ...
    <div className="bg-zinc-800 border border-zinc-700 rounded-xl p-8 max-w-md w-full mx-auto shadow-2xl">
      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              <Icon icon={Mail} preset="sm" className="text-zinc-500" />
            </div>
            <div className="relative">
              <input
                type="email"
              ...
              {authMode === "register" &&
                ...
                authFormData.email && (
                  ...
                  >
                    {emailCheckResult.status === "registered_unverified" && (
                      <>
                        <Icon icon={AlertTriangle} preset="xs" className="mr-2 flex-shrink-0" />
                        <span>{t('ui.components.authForm.validation.emailRegisteredUnverified')}</span>
                      </>
                    )}
                    {emailCheckResult.status === "registered_verified" && (
                      <>
                        <Icon icon={CheckCircle} preset="xs" className="mr-2 flex-shrink-0" />
                    ...
                    {emailCheckResult.status === "not_registered" && (
                      <>
                        <Icon icon={Info} preset="xs" className="mr-2 flex-shrink-0" />
        ...
        <div>
          ...
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              <Icon icon={Lock} preset="sm" className="text-zinc-500" />
            </div>
            <div className="relative">
              <input
              ...
              >
                {showPassword ? (
                  <Icon icon={EyeOff} preset="xs" />
                ) : (
                  <Icon icon={Eye} preset="xs" />
                )}
              </button>
            </div>
          </div>
        ...
        {authMode === "register" && (
          <div>
            ...
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <Icon icon={CheckCircle} preset="sm" className="text-zinc-500" />
              </div>
              <div className="relative">
                <input
        ...
        {error && (
          <div className="bg-red-900/20 border border-red-800/50 rounded-lg p-4 text-red-400 text-sm">
            <div className="flex items-center gap-3">
              <Icon icon={Info} preset="sm" className="flex-shrink-0" />
              <span>{error}</span>
            </div>
          </div>
        )}
