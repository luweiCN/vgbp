-- 终极修复脚本：恢复工作状态并修复用户名问题
-- 基于之前能工作的 ORIGINAL_WORKING_RESTORE.sql 但修复了 profiles 表的自动创建逻辑
...
-- 2. 重新创建原始表结构（确保 username 字段正确工作）
